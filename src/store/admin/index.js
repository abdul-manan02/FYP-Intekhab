...
export const constituencyAtom = atom([]);
export const electionAtom = atom('');
export const partyRequestAtom = atom({});
export const candidateRequestAtom = atom({});
...
export const electionParticipationRequestAtom = atom([]);
